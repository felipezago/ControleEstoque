...
"color: rgb(0, 0, 0);")
        ...
        self.lbl_atalho_vis_venda_txt.setGeometry(QtCore.QRect(130, 40, 111, 20))
        self.lbl_atalho_vis_venda_txt.setObjectName("lbl_atalho_vis_venda_txt")
        self.lbl_atalho_vis_venda = Label(self.frame_atalhos)
        self.lbl_atalho_vis_venda.setGeometry(QtCore.QRect(174, 10, 41, 31))
        ...
        self.lbl_atalho_abrir_venda.setGeometry(QtCore.QRect(250, 40, 111, 20))
        self.lbl_atalho_abrir_venda.setObjectName("lbl_atalho_abrir_venda")
        self.lbl_atalho_abrir_venda_txt = Label(self.frame_atalhos)
        self.lbl_atalho_abrir_venda_txt.setGeometry(QtCore.QRect(290, 10, 41, 31))
        ...
        self.lbl_atalho_nova_compra = Label(self.frame_atalhos)
        self.lbl_atalho_nova_compra.setGeometry(QtCore.QRect(370, 40, 121, 20))
        self.lbl_atalho_nova_compra.setObjectName("lbl_atalho_nova_compra")
        self.lbl_atalho_nova_compra_txt = Label(self.frame_atalhos)
        self.lbl_atalho_nova_compra_txt.setGeometry(QtCore.QRect(410, 10, 41, 31))
        self.lbl_atalho_nova_compra_txt.setText("")
        self.lbl_atalho_nova_compra_txt.setPixmap(QtGui.QPixmap("Imagens/compras.png"))
        self.lbl_atalho_nova_compra_txt.setObjectName("lbl_atalho_nova_compra_txt")
        self.lbl_atalho_vis_compra_txt = Label(self.frame_atalhos)
        self.lbl_atalho_vis_compra_txt.setGeometry(QtCore.QRect(500, 40, 121, 20))
        self.lbl_atalho_vis_compra_txt.setObjectName("lbl_atalho_vis_compra_txt")
        self.lbl_atalho_vis_compra = Label(self.frame_atalhos)
        self.lbl_atalho_vis_compra.setGeometry(QtCore.QRect(540, 10, 41, 31))
        self.lbl_atalho_vis_compra.setText("")
        self.lbl_atalho_vis_compra.setPixmap(QtGui.QPixmap("Imagens/vis_compras.png"))
        self.lbl_atalho_vis_compra.setObjectName("lbl_atalho_vis_compra")
        self.lbl_atalho_pend = Label(self.frame_atalhos)
        self.lbl_atalho_pend.setGeometry(QtCore.QRect(670, 10, 41, 31))
        self.lbl_atalho_pend.setText("")
        self.lbl_atalho_pend.setPixmap(QtGui.QPixmap("Imagens/pend.png"))
        self.lbl_atalho_pend.setObjectName("lbl_atalho_pend")
        self.lbl_atalho_pend_txt = Label(self.frame_atalhos)
        self.lbl_atalho_pend_txt.setGeometry(QtCore.QRect(630, 40, 121, 20))
        self.lbl_atalho_pend_txt.setObjectName("lbl_atalho_pend_txt")
        ...
        self.menuVenda = QtWidgets.QMenu(self.menuMovimentos)
        self.menuVenda.setObjectName("menuVenda")
        self.menuCompra = QtWidgets.QMenu(self.menuMovimentos)
        ...
        self.actionNova_Compra = QtWidgets.QAction(MainWindow)
        self.actionNova_Compra.setObjectName("actionNova_Compra")
        self.actionVisualizar_Compras = QtWidgets.QAction(MainWindow)
        self.actionVisualizar_Compras.setObjectName("actionVisualizar_Compras")
        self.actionVisualizar_Pendencias = QtWidgets.QAction(MainWindow)
        self.actionVisualizar_Pendencias.setObjectName("actionVisualizar_Pendencias")
        self.actionNovaVenda = QtWidgets.QAction(MainWindow)
        self.actionNovaVenda.setObjectName("actionNovaVenda")
        self.actionVisualizar_Venda = QtWidgets.QAction(MainWindow)
        self.actionVisualizar_Venda.setObjectName("actionVisualizar_Venda")
        self.actionAbrirVenda = QtWidgets.QAction(MainWindow)
        self.actionAbrirVenda.setObjectName("actionAbrirVenda")
        self.actionNovaCompra = QtWidgets.QAction(MainWindow)
        self.actionNovaCompra.setObjectName("actionNovaCompra")
        self.actionVisualizarCompras = QtWidgets.QAction(MainWindow)
        self.actionVisualizarCompras.setObjectName("actionVisualizarCompras")
        ...
        self.menuFinanceiro.addAction(self.actionVisualizar_Pendencias)
        self.menuVenda.addAction(self.actionNovaVenda)
        self.menuVenda.addAction(self.actionVisualizar_Venda)
        self.menuVenda.addAction(self.actionAbrirVenda)
        self.menuCompra.addAction(self.actionNovaCompra)
        self.menuCompra.addAction(self.actionVisualizarCompras)
        self.menuMovimentos.addAction(self.menuVenda.menuAction())
        self.menuMovimentos.addAction(self.menuCompra.menuAction())
        self.menuMovimentos.addAction(self.actionRelatorio)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.lbl_atalho_nova_compra.setText(_translate("MainWindow", "F8 - Nova Compra"))
        self.lbl_atalho_vis_compra_txt.setText(_translate("MainWindow", "F9 - Vis. Compras"))
        self.lbl_atalho_pend_txt.setText(_translate("MainWindow", "F10 - Pendencias"))
        ...
        self.menuVenda.setTitle(_translate("MainWindow", "Venda"))
        ...
        self.actionRelatorio.setText(_translate("MainWindow", "Relatório"))
        ...
        self.actionNova_Compra.setText(_translate("MainWindow", "Nova Compra"))
        self.actionVisualizar_Compras.setText(_translate("MainWindow", "Visualizar Compras"))
        self.actionVisualizar_Pendencias.setText(_translate("MainWindow", "Pendencias Financeiras"))
        self.actionNovaVenda.setText(_translate("MainWindow", "Nova Venda"))
        self.actionVisualizar_Venda.setText(_translate("MainWindow", "Visualizar Vendas"))
        self.actionAbrirVenda.setText(_translate("MainWindow", "Abrir Venda"))
        self.actionNovaCompra.setText(_translate("MainWindow", "Nova Compra"))
        self.actionVisualizarCompras.setText(_translate("MainWindow", "Visualizar Compras"))
