...
"color: rgb(0, 0, 0);")
        ...
        self.lbl_atalho_venda_txt.setGeometry(QtCore.QRect(6, 40, 81, 20))
        self.lbl_atalho_venda_txt.setObjectName("lbl_atalho_venda_txt")
        self.lbl_atalho_venda = Label(self.frame_atalhos)
        self.lbl_atalho_venda.setGeometry(QtCore.QRect(30, 10, 41, 31))
        self.lbl_atalho_venda.setText("")
        self.lbl_atalho_venda.setPixmap(QtGui.QPixmap("Imagens/venda.png"))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.lbl_atalho_venda_txt.setText(_translate("MainWindow", "F5 - Vendas"))
