...
# Form implementation generated from reading ui file '.\UI\cadastro_produtos.ui'
#
...
class Ui_ct_FormProdutos(object):
    def setupUi(self, ct_FormProdutos):
        ...
        ct_FormProdutos.resize(662, 432)
...
"}")
        ...
        self.lb_FotoProduto.setGeometry(QtCore.QRect(20, 99, 150, 161))
...
"}")
        ...
        self.tx_ValorUnitarioProduto.setGeometry(QtCore.QRect(20, 350, 150, 30))
